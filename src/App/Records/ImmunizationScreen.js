    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="medical" size={80} color="#f39c12" />
          <Text style={styles.comingSoonTitle}>Immunization</Text>
          <Text style={styles.comingSoonText}>Keep track of your vaccination history.</Text>
          <Text style={styles.comingSoonSubtext}>💉 Vaccination records{'\n'}📅 Schedule reminders{'\n'}🗓️ Due dates</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
