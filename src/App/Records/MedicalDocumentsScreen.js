    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="document" size={80} color="#8e44ad" />
          <Text style={styles.comingSoonTitle}>Medical Documents</Text>
          <Text style={styles.comingSoonText}>Store and organize your medical documents.</Text>
          <Text style={styles.comingSoonSubtext}>📄 Document storage{'\n'}📁 Organization{'\n'}📤 Share with doctors</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#8e44ad' },
  ...
  comingSoonSubtext: { fontSize: 16, color: '#8e44ad', textAlign: 'center', lineHeight: 28 }
});
