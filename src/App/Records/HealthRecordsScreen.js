    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          ...
          <Text style={styles.comingSoonText}>Access and manage your complete health records and medical history.</Text>
          <Text style={styles.comingSoonSubtext}>📄 Medical documents{'\n'}🩺 Lab results{'\n'}💉 Vaccination records</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
