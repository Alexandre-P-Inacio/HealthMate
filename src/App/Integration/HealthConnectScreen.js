    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="heart" size={80} color="#27ae60" />
          <Text style={styles.comingSoonTitle}>Health Connect</Text>
          <Text style={styles.comingSoonText}>Integrate with Android Health Connect for comprehensive health data.</Text>
          <Text style={styles.comingSoonSubtext}>📊 Health data sync{'\n'}🔗 App integration{'\n'}📱 Platform connection</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
