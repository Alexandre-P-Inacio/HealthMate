    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="bluetooth" size={80} color="#34495e" />
          <Text style={styles.comingSoonTitle}>Device Connection</Text>
          <Text style={styles.comingSoonText}>Connect and manage your health monitoring devices.</Text>
          <Text style={styles.comingSoonSubtext}>📡 Bluetooth pairing{'\n'}⚙️ Device settings{'\n'}🔄 Data sync</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
