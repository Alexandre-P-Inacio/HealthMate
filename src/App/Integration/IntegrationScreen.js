    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="link" size={80} color="#16a085" />
          <Text style={styles.comingSoonTitle}>Device Integrations</Text>
          <Text style={styles.comingSoonText}>Connect your health devices and apps for seamless data sync.</Text>
          <Text style={styles.comingSoonSubtext}>⌚ Smartwatches{'\n'}📱 Health apps{'\n'}🔗 API connections</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
