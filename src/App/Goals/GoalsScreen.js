    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="trophy" size={80} color="#1abc9c" />
          <Text style={styles.comingSoonTitle}>Health Goals</Text>
          <Text style={styles.comingSoonText}>Set and track your health and wellness goals.</Text>
          <Text style={styles.comingSoonSubtext}>🎯 Goal setting{'\n'}📊 Progress tracking{'\n'}🏆 Achievements</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#1abc9c' },
  ...
  comingSoonSubtext: { fontSize: 16, color: '#1abc9c', textAlign: 'center', lineHeight: 28 }
});
