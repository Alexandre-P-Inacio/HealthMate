...
const ChallengesScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <LinearGradient colors={['#e67e22', '#d35400']} style={styles.header}>
        <TouchableOpacity style={styles.backButton} onPress={() => navigation.goBack()}>
          <Ionicons name="arrow-back" size={24} color="#fff" />
        </TouchableOpacity>
        <Text style={styles.headerTitle}>Health Challenges</Text>
        <View style={styles.placeholder} />
      </LinearGradient>

      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="fitness" size={80} color="#e67e22" />
          <Text style={styles.comingSoonTitle}>Health Challenges</Text>
          <Text style={styles.comingSoonText}>Join exciting health challenges and compete with friends.</Text>
          <Text style={styles.comingSoonSubtext}>🏃‍♂️ Fitness challenges{'\n'}👥 Community events{'\n'}🏆 Competitions</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#e67e22' },
  ...
  comingSoonSubtext: { fontSize: 16, color: '#e67e22', textAlign: 'center', lineHeight: 28 }
});
