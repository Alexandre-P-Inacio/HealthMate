...
const EmergencyScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <LinearGradient colors={['#e74c3c', '#f39c12']} style={styles.header}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="warning" size={80} color="#e74c3c" />
          <Text style={styles.comingSoonTitle}>Emergency Services</Text>
          <Text style={styles.comingSoonText}>Quick access to emergency services and medical assistance.</Text>
          <Text style={styles.comingSoonSubtext}>🚨 Call 911{'\n'}🏥 Nearest hospital{'\n'}💊 Medical ID</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
