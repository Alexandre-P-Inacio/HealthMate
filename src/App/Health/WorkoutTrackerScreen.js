    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="fitness" size={80} color="#66BB6A" />
          <Text style={styles.comingSoonTitle}>Workout Tracker</Text>
          <Text style={styles.comingSoonText}>Track your exercises, workouts, and fitness progress.</Text>
          <Text style={styles.comingSoonSubtext}>🏋️ Exercise logging{'\n'}📈 Progress tracking{'\n'}🎯 Fitness goals</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
