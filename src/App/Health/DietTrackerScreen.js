    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="restaurant" size={80} color="#FF9800" />
          <Text style={styles.comingSoonTitle}>Diet Tracker</Text>
          <Text style={styles.comingSoonText}>Track your meals, calories, and nutrition intake.</Text>
          <Text style={styles.comingSoonSubtext}>🍎 Meal logging{'\n'}📊 Calorie tracking{'\n'}🥗 Nutrition analysis</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  comingSoonSubtext: { fontSize: 16, color: '#FF9800', textAlign: 'center', lineHeight: 28 }
});
