    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="water" size={80} color="#26C6DA" />
          <Text style={styles.comingSoonTitle}>Water Tracker</Text>
          <Text style={styles.comingSoonText}>Stay hydrated and track your daily water intake.</Text>
          <Text style={styles.comingSoonSubtext}>💧 Daily water goals{'\n'}📊 Hydration analytics{'\n'}⏰ Drink reminders</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  comingSoonSubtext: { fontSize: 16, color: '#26C6DA', textAlign: 'center', lineHeight: 28 }
});
