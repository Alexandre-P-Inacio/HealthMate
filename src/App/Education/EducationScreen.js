    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="library" size={80} color="#2980b9" />
          <Text style={styles.comingSoonTitle}>Health Education</Text>
          <Text style={styles.comingSoonText}>Learn about health topics and improve your wellness knowledge.</Text>
          <Text style={styles.comingSoonSubtext}>📚 Health articles{'\n'}🎥 Educational videos{'\n'}💡 Tips & guides</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#2980b9' },
  ...
  comingSoonSubtext: { fontSize: 16, color: '#2980b9', textAlign: 'center', lineHeight: 28 }
});
