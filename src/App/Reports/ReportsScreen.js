    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          ...
          <Text style={styles.comingSoonTitle}>Health Reports</Text>
          <Text style={styles.comingSoonText}>Generate comprehensive health reports and analytics for your wellness journey.</Text>
          <Text style={styles.comingSoonSubtext}>📊 Health analytics{'\n'}📈 Progress tracking{'\n'}📋 Medical summaries</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
