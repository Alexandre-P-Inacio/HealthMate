    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="download" size={80} color="#f39c12" />
          <Text style={styles.comingSoonTitle}>Export Data</Text>
          <Text style={styles.comingSoonText}>Export your health data in various formats for sharing with healthcare providers.</Text>
          <Text style={styles.comingSoonSubtext}>📄 PDF reports{'\n'}📊 CSV data files{'\n'}📱 Share with doctors</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
