    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="analytics" size={80} color="#9b59b6" />
          <Text style={styles.comingSoonTitle}>Health Insights</Text>
          <Text style={styles.comingSoonText}>AI-powered insights into your health patterns and trends.</Text>
          <Text style={styles.comingSoonSubtext}>🤖 AI analysis{'\n'}📊 Health patterns{'\n'}💡 Recommendations</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
