    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="time" size={80} color="#4ECDC4" />
          <Text style={styles.comingSoonTitle}>Appointment History</Text>
          <Text style={styles.comingSoonText}>View your complete appointment history and medical records.</Text>
          <Text style={styles.comingSoonSubtext}>📅 Past appointments{'\n'}📋 Medical records{'\n'}🏥 Doctor notes</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
