    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="fitness" size={80} color="#27ae60" />
          <Text style={styles.comingSoonTitle}>Health Profile</Text>
          <Text style={styles.comingSoonText}>Manage your health information and medical profile.</Text>
          <Text style={styles.comingSoonSubtext}>🩺 Medical history{'\n'}💊 Allergies & conditions{'\n'}📋 Health summary</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
