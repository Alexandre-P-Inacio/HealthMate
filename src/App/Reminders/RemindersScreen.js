    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          ...
          <Text style={styles.comingSoonTitle}>Health Reminders</Text>
          <Text style={styles.comingSoonText}>Set up medication and appointment reminders.</Text>
          <Text style={styles.comingSoonSubtext}>💊 Medication alerts{'\n'}📅 Appointment reminders{'\n'}🔔 Custom notifications</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
