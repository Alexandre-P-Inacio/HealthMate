    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.comingSoonContainer}>
          <Ionicons name="notifications" size={80} color="#9b59b6" />
          <Text style={styles.comingSoonTitle}>Notification Settings</Text>
          <Text style={styles.comingSoonText}>Customize your notification preferences and schedules.</Text>
          <Text style={styles.comingSoonSubtext}>🔔 Notification types{'\n'}⏰ Custom schedules{'\n'}🔕 Do not disturb</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
